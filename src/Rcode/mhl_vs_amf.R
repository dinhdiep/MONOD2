...
adult_stl_samples <- c('STL002SB-01.allchrs.sorted.clipped.bam.mhbs', 'STL003SB-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003SG-01.allchrs.sorted.clipped.bam.mhbs', 'STL002EG-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003EG-01.allchrs.sorted.clipped.bam.mhbs', 'STL002FT-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003FT-01.allchrs.sorted.clipped.bam.mhbs', 'STL003LV-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003RV-01.allchrs.sorted.clipped.bam.mhbs', 'STL002AD-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003AD-01.allchrs.sorted.clipped.bam.mhbs', 'STL011LI-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL002LG-01.allchrs.sorted.clipped.bam.mhbs', 'STL002PO-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003PO-01.allchrs.sorted.clipped.bam.mhbs', 'STL002OV-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL002PA-01.allchrs.sorted.clipped.bam.mhbs', 'STL003PA-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL002SX-01.allchrs.sorted.clipped.bam.mhbs', 'STL003SX-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL002GA-01.allchrs.sorted.clipped.bam.mhbs', 'STL003GA-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL002AO-01.allchrs.sorted.clipped.bam.mhbs', 'STL003AO-01.allchrs.sorted.clipped.bam.mhbs', 
                       'STL003RA-01.allchrs.sorted.clipped.bam.mhbs')

adult_stl_samples <- make.names(sapply(adult_stl_samples, function(x) strsplit(x, split = "\\.")[[1]][[1]]))
